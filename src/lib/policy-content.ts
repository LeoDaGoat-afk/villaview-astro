// Policy page content (ja / en / zh / zh-Hant). Other langs fall back to English.

type PolicyContent = { ja: string; en: string; zh: string; zhHant: string };

export const privacy: PolicyContent = {
  ja: `VILLA VIEW（以下、「当施設」）は、お客様の個人情報の保護を最重要事項と考え、以下の方針に基づき、適切に取り扱います。

■ 1. 取得する個人情報
当施設は、ご予約・チェックイン手続きにあたり、以下の情報を取得することがあります。
・氏名（漢字・ローマ字）
・国籍・生年月日
・住所・電話番号・メールアドレス
・パスポート情報（外国籍のお客様）
...
■ 5. 開示・訂正・削除
お客様ご本人から個人情報の開示・訂正・削除のご請求があった場合、合理的な範囲で速やかに対応します。

■ 6. クッキー（Cookie）の使用
当施設のウェブサイトは、サービス向上のためクッキーを使用することがあります。ブラウザの設定により無効化できます。

■ 7. お問い合わせ窓口
個人情報の取扱いに関するお問い合わせは、以下までご連絡ください。
VILLA VIEW
〒901-1407 沖縄県南城市つきしろ1663-9
電話: +81 98-894-2474
...
The Property may collect the following information in connection with reservations and check-in procedures:
- Name (full name in romanized form)
- Nationality and date of birth
- Address, phone number, email
- Passport information (for non-Japanese guests)
- Credit card information (during payment only)
- Stay history and inquiry content

■ 2. Purpose of Use
We use collected personal information for the following purposes:
- Accepting, confirming, and canceling accommodation reservations
- Check-in / check-out procedures
- Providing accommodation services and facility management
- Creating and maintaining guest registers as required by Japanese hotel business law
- Responding to customer inquiries
- Sending booking confirmation and stay information emails
- Notifying about official deals and campaigns (only if you opt in)
...
Upon request from the individual concerned, we will respond promptly and reasonably to requests for disclosure, correction, or deletion of personal information.

■ 6. Use of Cookies
Our website may use cookies to improve services. You can disable them through your browser settings.

■ 7. Contact
For inquiries regarding the handling of personal information, please contact:
VILLA VIEW
1663-9 Tsukishiro, Nanjo, Okinawa 901-1407, Japan
Phone: +81 98-894-2474
...
■ 5. 信息的披露、更正与删除
如客户本人提出查询、更正或删除个人信息的请求，本设施将在合理范围内迅速予以回应。

■ 6. Cookie 的使用
本设施的网站可能为提升服务体验而使用 Cookie。您可通过浏览器设置将其禁用。

■ 7. 联系方式
有关个人信息处理的咨询，请联系：
VILLA VIEW
〒901-1407 冲绳县南城市つきしろ1663-9
电话: +81 98-894-2474
...
■ 5. 資料的查閱、更正與刪除
若客戶本人提出查閱、更正或刪除個人資料的請求，本設施將於合理範圍內迅速回應。

■ 6. Cookie 的使用
本設施的網站可能為提升服務體驗而使用 Cookie。您可透過瀏覽器設定將其停用。

■ 7. 聯絡方式
有關個人資料處理的諮詢，請聯絡：
VILLA VIEW
〒901-1407 沖繩縣南城市つきしろ1663-9
電話: +81 98-894-2474
...
export const terms: PolicyContent = {
  ja: `本利用規約（以下「本規約」）は、VILLA VIEW（以下「当施設」）が提供する宿泊サービスの利用条件を定めるものです。ご予約をもって、お客様は本規約に同意したものとみなします。
...
※ 自然災害・交通機関の運休等、不可抗力によるキャンセルは個別にご相談ください。

■ 4. 宿泊定員
・最大宿泊人数を超えるご利用はお断りします。
・乳幼児を含むすべての方が定員に含まれます。
...
■ 6. 損害賠償
お客様の故意または過失により、施設・設備・備品を損傷・紛失された場合、修理・交換実費をご請求します。

■ 7. 免責事項
・お客様の所持品の盗難・紛失について、当施設は責任を負いません。貴重品はセーフボックスをご利用ください。
・自然災害・停電・断水等、当施設の責によらない事象による損害については、責任を負いません。

■ 8. 規約の変更
当施設は、必要に応じて本規約を変更することがあります。変更後の規約は、当ウェブサイトに掲載した時点から効力を生じます。

■ 9. 準拠法・管轄
本規約は日本法に準拠し、本規約に関する一切の紛争は、那覇地方裁判所を第一審の専属的合意管轄裁判所とします。
...
* Cancellations due to natural disasters or transportation suspension may be discussed individually.

■ 4. Maximum Occupancy
- We do not accept use exceeding the maximum number of guests.
- All persons, including infants, count toward the maximum capacity.
...
■ 6. Damages
If our facilities, equipment, or amenities are damaged or lost due to your willful act or negligence, we will charge the actual cost of repair or replacement.

■ 7. Disclaimer
- We are not responsible for theft or loss of your personal belongings. Please use the safe box for valuables.
- We are not liable for damages caused by events beyond our control, such as natural disasters, power outages, or water suspension.

■ 8. Changes to Terms
We may revise these Terms as necessary. Revised Terms take effect upon posting on our website.

■ 9. Governing Law and Jurisdiction
These Terms are governed by Japanese law. Any disputes shall be exclusively resolved in the Naha District Court as the court of first instance.
...
■ 6. 损害赔偿
若因客户故意或过失导致设施、设备、物品损坏或丢失，将按实际维修或更换费用收取。

■ 7. 免责声明
・本设施不对客户随身物品的盗窃或遗失承担责任。贵重物品请使用保险箱。
・对于自然灾害、停电、停水等不可抗力造成的损失，本设施不承担责任。

■ 8. 条款变更
本设施可根据需要修改本条款。修改后的条款自在本网站公布之时起生效。

■ 9. 适用法律及管辖
本条款适用日本法律。与本条款有关的一切纠纷，以那霸地方法院为第一审专属合意管辖法院。
...
透過官方網站預訂時，取消費用如下：
・入住日 14 天前：免費
・入住日 13–7 天前：住宿費用的 30%
・入住日 6 天前–前一天：住宿費用的 50%
・入住當日／未告知即未入住：住宿費用的 100%

※ 透過 OTA 的預訂，依各 OTA 的取消規定辦理。
※ 因天然災害、交通工具停駛等不可抗力造成的取消，可個別洽談。
...
■ 5. 禁止行為
在本設施內及周邊禁止以下行為：
・在館內吸菸（館內全面禁菸）。如發現吸菸，將收取特別清潔費 50,000 日圓。
・大聲喧嘩（尤其是夜間 22:00 之後）
・未經許可的第三人進入或住宿
・攜帶小型犬以外的寵物（導盲犬除外）
・故意損壞設施或物品
...
■ 6. 損害賠償
若因客戶故意或過失導致設施、設備、物品損壞或遺失，將依實際維修或更換費用收取。

■ 7. 免責聲明
・本設施對客戶隨身物品的失竊或遺失不負責任。貴重物品請使用保險箱。
・對於天然災害、停電、停水等不可抗力造成的損失，本設施不負責任。

■ 8. 條款變更
本設施得視需要修改本條款。修改後的條款自公布於本網站時起生效。

■ 9. 準據法及管轄
本條款適用日本法律。與本條款有關的一切爭議，以那霸地方法院為第一審專屬合意管轄法院。
...
export const contact: PolicyContent = {
  ja: `VILLA VIEW へのお問い合わせは、以下の方法でご連絡ください。
...
Q. キャンセルはどうすればよいですか？
A. ご予約サイト（Beds24・OTA）よりキャンセル手続きをお願いします。詳細は利用規約のキャンセルポリシーをご確認ください。

Q. 当日のチェックイン時間に遅れる場合は？
A. 上記電話番号またはメールにてご連絡ください。
...
■ Phone
+81 98-894-2474
(Hours: 9:00–21:00 JST)

■ Email
info.serena.breeze@gmail.com
(24/7 inquiries / typically replied within 24 hours)
...
A. Please cancel through the booking site (Beds24 / OTA). Refer to the cancellation policy in our Terms for details.

Q. What if I'm late for check-in?
A. Please contact us via phone or email above.
...
Q. 如何取消预订？
A. 请通过预订网站（Beds24 或 OTA）办理取消手续。详细取消规定请参阅服务条款。
...
A. 仅可携带小型犬，每晚2,000日元（请提前告知我们）。小型犬以外的动物恕不接受。导盲犬不受此限。`,
  zhHant: `如有任何諮詢，請透過以下方式聯絡 VILLA VIEW。

■ 電話
+81 98-894-2474
（受理時間：日本時間 9:00–21:00）
...
Q. 如何取消預訂？
A. 請透過預訂網站（Beds24 或 OTA）辦理取消手續。詳細取消規定請參閱服務條款。
...
export const tokushoho: PolicyContent = {
  ja: `特定商取引法第11条に基づき、以下の事項を表示いたします。
...
■ URL
https://villaokinawa.com

■ サービス内容
宿泊施設「VILLA VIEW」の運営および関連サービスの提供

■ 販売価格
各客室・宿泊プランページに記載のとおり（消費税込）。
通貨は日本円（JPY）にて表示します。
...
■ 動作環境
最新バージョンの主要ブラウザ（Chrome / Safari / Firefox / Edge）を推奨します。
...
■ Business Name
Okinawa Koukou Co., Ltd. (沖縄高興株式会社)
...
■ Services Offered
Operation of the accommodation facility "VILLA VIEW" and related services.

■ Pricing
As displayed on each room and plan page (consumption tax included).
...
Latest versions of major browsers (Chrome / Safari / Firefox / Edge) recommended.
...
■ 运行环境
推荐使用最新版本的主流浏览器（Chrome / Safari / Firefox / Edge）。
...
透過 OTA 預訂者，依各 OTA 的取消規定辦理。

■ 運作環境
建議使用最新版本的主流瀏覽器（Chrome / Safari / Firefox / Edge）。
...
export function pickPolicy(content: PolicyContent, lang: string): string {
  if (lang === 'ja') return content.ja;
  if (lang === 'zh-Hant') return content.zhHant;
  if (lang === 'zh') return content.zh;
  return content.en;
}
