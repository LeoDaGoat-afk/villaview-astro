// Policy page content (ja / en / zh). Other langs fall back to English.

type PolicyContent = { ja: string; en: string; zh: string };
...
export function pickPolicy(content: PolicyContent, lang: string): string {
  ...
  if (lang === 'zh' || lang === 'zh-Hant') return content.zh;
  return content.en;
}
