/* VILLA VIEW — Beds24 body-top injection.
   ...
   booking form shows the new one — two different prices on the same page. Always change both.
...
(function () {
  ...
  var I18N = {
    ja: {
      ...
      heroEyebrow: 'OKINAWA · NANJO', heroTitle: 'VILLA VIEW', heroSub: '沖縄の海を望む、4寝室・8名様までの貸切ヴィラ',
      ...
      f1Lbl: '4 ベッドルーム', f1Desc: '2階に3室、1階に和室が1室',
      f2Lbl: '最大8名', f2Desc: 'ファミリー・ご友人グループに',
      f3Lbl: '海を望む', f3Desc: '寝室やホールから海が見える',
      f4Lbl: '屋根付きバルコニー', f4Desc: '屋根付きで多少の雨でもBBQ可',
      f5Lbl: '1階のホール', f5Desc: 'マットを何枚も広げられる広さ',
      f6Lbl: 'フルキッチン', f6Desc: '長期滞在にも対応',
      amenTitle: '無料の特典', amenParking: '無料駐車場', amenSauna: '無料サウナ', amenWifi: '無料 Wi-Fi',
      footBrand: 'VILLA VIEW', footTag: '沖縄南城・海を望む貸切プライベートヴィラ',
    ...
    en: {
      ...
      f1Lbl: '4 Bedrooms', f1Desc: 'Three upstairs plus a tatami room',
      f2Lbl: 'Up to 8 Guests', f2Desc: 'Ideal for families and groups',
      f3Lbl: 'Ocean View', f3Desc: 'Visible from the bedrooms and hall',
      f4Lbl: 'Covered Balcony', f4Desc: 'Roofed, so you can grill in light rain',
      f5Lbl: 'Ground-Floor Hall', f5Desc: 'Wide enough to lay out several mats',
      ...
      footBrand: 'VILLA VIEW', footTag: 'A private oceanfront villa in Nanjo, Okinawa',
    ...
    zh: {
      ...
      heroEyebrow: '冲绳 · 南城', heroTitle: 'VILLA VIEW', heroSub: '眺望大海・4 卧室・最多 8 人独栋别墅',
      ...
      f1Lbl: '4 间卧室', f1Desc: '二楼三间，一楼和室一间',
      f2Lbl: '最多 8 人', f2Desc: '适合家庭与朋友聚会',
      f3Lbl: '海景', f3Desc: '从卧室和大厅都能看到大海',
      f4Lbl: '带屋顶的阳台', f4Desc: '有屋顶，小雨天也能烧烤',
      f5Lbl: '一楼大厅', f5Desc: '可铺开多张垫子的宽敞空间',
      f6Lbl: '全功能厨房', f6Desc: '适合长期居住',
      amenTitle: '免费设施', amenParking: '免费停车', amenSauna: '免费桑拿', amenWifi: '免费 Wi-Fi',
      footBrand: 'VILLA VIEW', footTag: '冲绳南城・眺望大海的私人独栋别墅',
