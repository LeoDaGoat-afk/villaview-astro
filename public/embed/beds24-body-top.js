...
(function () {
  ...
  var I18N = {
    ja: {
      ...
      polTitle: 'キャンセル規定', polSummary: '当日100% / 前日80% / 2日前まで20%',
      pol2d: '2日前まで', pol2dAmt: '宿泊料金の20%',
      pol1d: '前日', pol1dAmt: '宿泊料金の80%',
    ...
    en: {
      ...
      polTitle: 'Cancellation Policy', polSummary: 'Same day 100% / 1 day before 80% / 2+ days before 20%',
      pol2d: '2+ days before', pol2dAmt: '20% of room rate',
      pol1d: '1 day before', pol1dAmt: '80% of room rate',
    ...
    zh: {
      ...
      accessParking: '免费停车',
      polTitle: '退订规定', polSummary: '当日100% / 前1日80% / 提前2日以上20%',
      pol2d: '提前2日以上', pol2dAmt: '收取房费20%',
      pol1d: '前1日', pol1dAmt: '收取房费80%',
